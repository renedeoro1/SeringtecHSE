...
Public Class reportesCasos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                drop_02_T01Id_Area.AutoPostBack = True
                Verificar_Perfil()
                CargarDrops()
                limpiarCampos()
            ...
            If Not IsNothing(Request.QueryString("ID")) Then
                Dim sContenido_TEm = Request.QueryString("ID").ToString
                txt_02_T01Id_Reporte.Text = sContenido_TEm
                Datos_Modulo()
                Cargar_Registro()
            End If
    ...
    Private Sub limpiarCampos()
        ...
        If bValidarFecha(dFecha, Now.Day, Now.Month, Now.Year, sFecha) = True Then
            ...
            txt_02_T01Fecha.Text = sFecha
        Else
            txt_02_T01Fecha.Text = Nothing
        End If
        ...
        txt_02_T01Id_Sede.Text = Nothing
        txt_02_T01Dependenia.Text = Nothing
        txt_02_T01PersonaReporta_Nombre.Text = Nothing
        ...
        txt_02_T01Id_Sede.Enabled = False
        MostrarMensaje("")
    ...
    Private Function bValidarCampos() As Boolean
        ...
        Else
            lbl_02_T01Fecha.ForeColor = Drawing.Color.Black
        End If
        If txt_02_T01Fecha.Text.Length <> 10 Then
            txt_02_T01Fecha.Focus()
            MostrarMensaje("Formato Fecha  debe ser (dd/mm/aaaa) para el recurso ")
            Exit Function
        Else
            txt_02_T01Fecha.ForeColor = Drawing.Color.Black
        End If
        ...
        Else
            lbl_02_T01Id_Area.ForeColor = Drawing.Color.Black
        End If
        'If Trim(txt_02_T01Id_Sede.Text) = "" Then
        '    txt_02_T01Id_Sede.Focus()
    ...
    Private Sub Cargar_Registro()
        ...
        If Not coleccionDatos Is Nothing Then
            ...
            Else
                ...
                txt_02_T01Id_Sede.Text = coleccionDatos(10)
    ...
    Private Sub cargar_Tabla(Optional ByVal sLlaveTem As String = "")
        ...
        Dim sLlavesLocal As String = "_02_T02Id = _02_T01Id_TipoAccion"
        Dim sTablaLocal As String = "_02_T01REPORTE_CASOS, _02_T02TIPO_ACCION"
        Dim ArregloSingular() As String
        ...
        If (Not coleccionDatosPlural Is Nothing) Then
            For Each ColeccionSingular In coleccionDatosPlural
                ...
                For i = 0 To ArregloSingular.Count - 3
                    CeldaHtml = New HtmlTableCell
                    linkbutonHtml = New LinkButton
                    linkbutonHtml.ID = i & "-sep-" & ArregloSingular(4).ToString & "-sep-" '& ArregloSingular(1).ToString & "sep" & ArregloSingular(2).ToString & "sep" & ArregloSingular(4).ToString
                    AddHandler linkbutonHtml.Click, AddressOf linkbutonHtml_Click
    ...
    Private Sub linkbutonHtml_Eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles linkbutonHtml_Eliminar.Click
        ...
        Dim sLlaves_Tem = _02_T01REPORTE_CASOS.CampoLlave_02_T01Id_Reporte & "='" & sllave1 & "'"
    ...
    Private Sub linkbutonHtml_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles linkbutonHtml.Click
        ...
        'Cargar_Registro()
        sLlaves = _02_T01REPORTE_CASOS.CampoLlave_02_T01Id_Reporte & "='" & sllave1 & "'"
    ...
    Private Sub drop_02_T01Id_Area_TextChanged(sender As Object, e As EventArgs) Handles drop_02_T01Id_Area.TextChanged
        If drop_02_T01Id_Area.Text = "01" Then
            txt_02_T01Id_Sede.Enabled = True
        Else
            txt_02_T01Id_Sede.Enabled = False
        End If
    End Sub
    ...
    Private Sub btnImprimir_Click(sender As Object, e As EventArgs) Handles btnImprimir.Click
        Dim clsAdminDb As New adminitradorDB
        Dim sCamposTablaLocal As String = "_02_T01Id_Reporte,_02_T01FechaRegistro,_02_T01DocUsuarioRegistra,_02_T01Fecha,_02_T01Hora,_02_T02Nombre as _02_T01Id_TipoAccion2,_02_T01LugarEvento,_02_T01DescripcionEvento,_02_T01SugerenciaEvento,_02_T01Id_Area,_02_T01Id_Sede,_02_T01Dependenia,_02_T01PersonaReporta_Nombre,_02_T01PersonaReporta_Contacto"
        Dim sLlavesLocal As String = "_02_T02Id = _02_T01Id_TipoAccion and _02_T01Id_Reporte='" & txt_02_T01Id_Reporte.Text & "'"
        Dim sTablaLocal As String = "_02_T01REPORTE_CASOS, _02_T02TIPO_ACCION"
