<%@ Page Debug="true" ValidateRequest="false" Language="vb" AutoEventWireup="false" CodeBehind="Area.aspx.vb" Inherits="HSENUEVO.Area" %>
                                            ...
                                            <div class="pure-g-r">
                                                <div class="pure-u-1">
                                                    <table>
                                                        <tr>
                                                            <td style="width: 80px">
                                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/iconos/Area.png" />
                                                            </td>
                                                            <td>
                                                                <h1>Tipo Vehiculo</h1>
                                                            </td>
                                                        ...
                                                        <div id="divContendio" runat="server" class="pure-form pure-form-stacked">
                                                            <div class="pure-g-r">
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T20Codigo" runat="server" Text="0Codigo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T20Codigo" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T20Codigo" runat="server" Enabled="True" TargetControlID="txt_02_T20Codigo" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T20Nombre" runat="server" Text="0Nombre" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T20Nombre" runat="server" Width="90%" MaxLength="300"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T20Nombre" runat="server" Enabled="True" TargetControlID="txt_02_T20Nombre" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T20Activo" runat="server" Text="0Activo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:DropDownList ID="drop_02_T20Activo" runat="server" class="chzn-select" Width="90%" placeholder="1_T20Activo"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </fieldset>
