...
Public Class Tipovehiculo
    ...
    Private Sub Datos_Modulo()
        sCodModulo = _02_T19TIPOVEHICULO.CodigoModulo
        sNombreTabla = _02_T19TIPOVEHICULO.NombreTabla
        sCamposTabla = _02_T19TIPOVEHICULO.CamposTabla
        sCamposINS = "'" & clsAdminDb.sRemoverHTML(txt_02_T19Codigo.text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_02_T19Nombre.text) & "'" & "," & "'" & drop_02_T19Activo.text & "'"
        sCamposUPD = _02_T19TIPOVEHICULO.Campo_02_T19Nombre & "='" & clsAdminDb.sRemoverHTML(txt_02_T19Nombre.text) & "'" & "," & _02_T19TIPOVEHICULO.Campo_02_T19Activo & "='" & drop_02_T19Activo.text & "'"
        sLlaves = _02_T19TIPOVEHICULO.CampoLlave_02_T19Codigo & "=  '" & txt_02_T19Codigo.text & "'"
    End Sub
    ...
    Private Sub CargarDrops()
        ...
        With clsAdminDb
            ...
            drop_02_T19Activo.Items.Add(New ListItem("Seleccionar"))
            drop_02_T19Activo.Items.Add(New ListItem("Si"))
            drop_02_T19Activo.Items.Add(New ListItem("No"))
        End With
    End Sub
    ...
    Private Sub limpiarCampos()
        ...
        txt_02_T19Codigo.text = Nothing
        txt_02_T19Nombre.text = Nothing
        drop_02_T19Activo.text = Nothing

        lbl_02_T19Codigo.ForeColor = Drawing.Color.Black
        lbl_02_T19Nombre.ForeColor = Drawing.Color.Black
        lbl_02_T19Activo.ForeColor = Drawing.Color.Black
    ...
    Private Sub bHabilitarControles(ByVal bEstado As Boolean)
        txt_02_T19Codigo.Enabled = bEstado
        txt_02_T19Nombre.Enabled = bEstado
        drop_02_T19Activo.Enabled = bEstado
    ...
    Private Function bValidarCampos() As Boolean
        ...
        lbl_02_T19Codigo.ForeColor = Drawing.Color.Red
        lbl_02_T19Nombre.ForeColor = Drawing.Color.Red
        lbl_02_T19Activo.ForeColor = Drawing.Color.Red
        If Trim(txt_02_T19Codigo.Text) = "" Then
            txt_02_T19Codigo.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 19Codigo")
            Exit Function
        Else
            lbl_02_T19Codigo.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_02_T19Nombre.Text) = "" Then
            txt_02_T19Nombre.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 19Nombre")
            Exit Function
        Else
            lbl_02_T19Nombre.ForeColor = Drawing.Color.Black
        End If
        If Trim(drop_02_T19Activo.Text) = "" Then
            drop_02_T19Activo.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 19Activo")
            Exit Function
        Else
            lbl_02_T19Activo.ForeColor = Drawing.Color.Black
        End If
    ...
    Private Function bValidarSQL() As Boolean
        ...
        If clsAdminDb.bVerificarSQL(txt_02_T19Codigo.text) Then Exit Function
        If clsAdminDb.bVerificarSQL(txt_02_T19Nombre.text) Then Exit Function
        bValidarSQL = True
        MostrarMensaje("")
    End Function
    ...
    Private Sub Cargar_Registro()
        ...
        If Not coleccionDatos Is Nothing Then
            If coleccionDatos.Length = 0 Then
                ...
                End If
            Else
                txt_02_T19Codigo.text = coleccionDatos(0)
                txt_02_T19Nombre.text = coleccionDatos(1)
                drop_02_T19Activo.text = coleccionDatos(2)
    ...
    Private Sub cargar_Tabla(Optional ByVal sLlaveTem As String = "")
        ...
        Dim sCamposTablaLocal As String = _02_T19TIPOVEHICULO.CamposTabla
        Dim sLlavesLocal As String = _02_T19TIPOVEHICULO.CampoLlave_02_T19Codigo & "<>''"
        Dim sTablaLocal As String = _02_T19TIPOVEHICULO.NombreTabla
        Dim ArregloSingular() As String
