...
Public Class InformHSE
    ...
    Private Sub limpiarCampos()
        ...
        drop_02_T03FechaSemana_Inicio.Text = Nothing
        drop_02_T03FechaSemana_Final.Text = Nothing
    ...
    Private Sub cargar_Tabla(Optional ByVal sLlaveTem As String = "")
        ...
        sconsulta += " from _02_T03NFORME_HSE_PROYECTOS "
        sconsulta += " where _02_T03ResponsableInforme='" & lblUsuarioLogueado_Documento.Text & "' "
        sconsulta += " order by cast (_02_T03Id_Informe as integer) desc"
        ...
        If (Not coleccionDatosPlural Is Nothing) Then
            For Each ColeccionSingular In coleccionDatosPlural
                ...
                linkbutonHtml_Editar.Text = "Editar"
