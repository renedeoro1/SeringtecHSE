...
Public Class rpt_InformeHSE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HSENUEVO.rpt_InformeHSE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_InformeHSE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_InformeHSE = New rpt_InformeHSE()
        rpt.Site = Me.Site
        Return rpt
    End Function
