...
Public Class rpt_InformeMensual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HSENUEVO.rpt_InformeMensual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_InformeMensual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_InformeMensual = New rpt_InformeMensual()
        rpt.Site = Me.Site
        Return rpt
    End Function
