...
Public Class rpt_Reporte_Casos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HSENUEVO.rpt_Reporte_Casos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Reporte_Casos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Reporte_Casos = New rpt_Reporte_Casos()
        rpt.Site = Me.Site
        Return rpt
    End Function
