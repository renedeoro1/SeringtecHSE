<%@ Page Debug="true" ValidateRequest="false" Language="vb" AutoEventWireup="false" CodeBehind="reportesCasosRPT.aspx.vb" Inherits="HSENUEVO.reportesCasosRPT" %>
                                                ...
                                                <div class="pure-u-1">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h1>Reporte Detallado de Casos</h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
...
<%--                                                                <div class="pure-u-1-3">
                                                                ...
                                                                <div class="pure-u-1-3">
                                                                    <asp:Label ID="lbl_02_T01Id_Area" runat="server" Text="Id de Area" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:DropDownList ID="drop_02_T01Id_Area" runat="server" class="chzn-select" Width="90%" placeholder="1_T20Activo"></asp:DropDownList>
                                                                </div>
                                                                <div class="pure-u-1-3">
                                                                    <asp:Label ID="lbl_02_T01Id_Sede" runat="server" Text="Sede" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:DropDownList ID="drop_02_T01Id_Sede" runat="server" class="chzn-select" Width="90%" placeholder="1_T20Activo"></asp:DropDownList>
                                                                </div>
<%--                                                                <div class="pure-u-1-3">
                                                                    <asp:Label ID="lbl_02_T01Id_Sede" runat="server" Text="Id de Sede" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T01Id_Sede" runat="server" Width="90%" MaxLength="30" Visible ="true" ></asp:TextBox>
                                                            ...
                                                            <div class="pure-g-r">
                                                                <div class="pure-u-1-2">
                                                                    <asp:Label ID="lbl_02_T01PersonaReporta_Nombre" runat="server" Text="Persona Reporta Nombre" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T01PersonaReporta_Nombre" runat="server" Width="90%" MaxLength="200"  Enabled ="false" ForeColor ="Black"  ></asp:TextBox>
                                                                ...
                                                                <div class="pure-u-1-2">
                                                                    <asp:Label ID="lbl_02_T01PersonaReporta_Contacto" runat="server" Text="Persona Reporta Contacto" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                    ...
                                                    <fieldset>
                                                        <div id="div2" runat="server" class="pure-form pure-form-stacked">
                                                            <div class="pure-g-r">
                                                                ...
                                                                <div class="pure-u-1-8">
                                                                    <asp:Label ID="Label5" runat="server" Text="Fecha inicial" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txtFechaInicial" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" Enabled="True" TargetControlID="txtFechaInicial" FilterType="Numbers,Custom" ValidChars="/"></asp:FilteredTextBoxExtender>
                                                                    <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtFechaInicial" Format="dd/MM/yyyy">
                                                                    </asp:CalendarExtender>
                                                                </div>
                                                                <div class="pure-u-1-8">
                                                                    <asp:Label ID="Label2" runat="server" Text="Fecha Final" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txtFechaFinal" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" Enabled="True" TargetControlID="txtFechaFinal" FilterType="Numbers,Custom" ValidChars="/"></asp:FilteredTextBoxExtender>
                                                                    <asp:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtFechaFinal" Format="dd/MM/yyyy">
                                                                    </asp:CalendarExtender>
                                                                </div>


                                                                <div class="pure-u-1-5">
                                                                    <asp:Label ID="Label8" runat="server" Text="Tipo de Accion" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:DropDownList ID="dropTipoAccion" runat="server" Width ="90%"></asp:DropDownList>                                                                    
                                                                </div>
                            ...
                            <div style="height: 8px"></div>
                                        ...
                                        <asp:Label ID="lbl_11_T04Sector0" runat="server" Font-Bold="True" Font-Size="10pt" Text="Busqueda Rapida" Visible ="false" ></asp:Label>
                                        <asp:TextBox ID="txtFiltroBusqueda" runat="server" class="input-xtipo160 text-tip" placeholder=""  Visible ="false" ></asp:TextBox>
                            ...
                            <table style="padding: 5px; border: thin solid #486794; background-color: #E8B617; font-weight: bold; color: #FFFFFF; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; vertical-align: middle; text-align: left; width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style ="width :150px">Abrir registro
                                        </th>
                                    </tr>
