<%@ Page Debug="true" ValidateRequest="false" Language="vb" AutoEventWireup="false" CodeBehind="Atlproces.aspx.vb" Inherits="HSENUEVO.Atlproces" %>
                                            ...
                                            <div class="pure-g-r">
                                                <div class="pure-u-1">
                                                    <table>
                                                        <tr>
                                                            <td style="width: 80px">
                                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/iconos/atl.png" />
                                                            </td>
                                                            <td>
                                                                <h1>Atl Proceso</h1>
                                                            </td>
                                                        ...
                                                        <div id="divContendio" runat="server" class="pure-form pure-form-stacked">
                                                            <div class="pure-g-r">
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_04_T11Codigo" runat="server" Text="Codigo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_04_T11Codigo" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_04_T11Codigo" runat="server" Enabled="True" TargetControlID="txt_04_T11Codigo" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_04_T11Nombre" runat="server" Text="Nombre" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_04_T11Nombre" runat="server" Width="90%" MaxLength="200"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_04_T11Nombre" runat="server" Enabled="True" TargetControlID="txt_04_T11Nombre" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_04_T11Activo" runat="server" Text="Activo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:DropDownList ID="drop_04_T11Activo" runat="server" class="chzn-select" Width="90%" placeholder="1_T11Activo"></asp:DropDownList>
                                                                </div>
