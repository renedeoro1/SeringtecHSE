...
Public Class Sede
    ...
    Private Sub Datos_Modulo()
        sCodModulo = _02_T21SEDE.CodigoModulo
        sNombreTabla = _02_T21SEDE.NombreTabla
        sCamposTabla = _02_T21SEDE.CamposTabla
        sCamposINS = "'" & clsAdminDb.sRemoverHTML(txt_02_T21Codigo.Text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_02_T21Nombre.Text) & "'" & "," & "'" & drop_02_T21Activo.Text & "'"
        sCamposUPD = _02_T21SEDE.Campo_02_T21Nombre & "='" & clsAdminDb.sRemoverHTML(txt_02_T21Nombre.Text) & "'" & "," & _02_T21SEDE.Campo_02_T21Activo & "='" & drop_02_T21Activo.Text & "'"
        sLlaves = _02_T21SEDE.CampoLlave_02_T21Codigo & "=  '" & txt_02_T21Codigo.Text & "'"
    End Sub
    ...
    Private Sub CargarDrops()
        ...
        With clsAdminDb
            ...
            drop_02_T21Activo.Items.Add(New ListItem("Seleccionar"))
            drop_02_T21Activo.Items.Add(New ListItem("Si"))
            drop_02_T21Activo.Items.Add(New ListItem("No"))
        End With
    End Sub
    ...
    Private Sub limpiarCampos()
        ...
        txt_02_T21Codigo.Text = Nothing
        txt_02_T21Nombre.Text = Nothing
        drop_02_T21Activo.Text = Nothing

        lbl_02_T21Codigo.ForeColor = Drawing.Color.Black
        lbl_02_T21Nombre.ForeColor = Drawing.Color.Black
        lbl_02_T21Activo.ForeColor = Drawing.Color.Black
    ...
    Private Sub bHabilitarControles(ByVal bEstado As Boolean)
        txt_02_T21Codigo.Enabled = bEstado
        txt_02_T21Nombre.Enabled = bEstado
        drop_02_T21Activo.Enabled = bEstado
    ...
    Private Function bValidarCampos() As Boolean
        ...
        lbl_02_T21Codigo.ForeColor = Drawing.Color.Red
        lbl_02_T21Nombre.ForeColor = Drawing.Color.Red
        lbl_02_T21Activo.ForeColor = Drawing.Color.Red
        If Trim(txt_02_T21Codigo.Text) = "" Then
            txt_02_T21Codigo.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 21Codigo")
            Exit Function
        Else
            lbl_02_T21Codigo.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_02_T21Nombre.Text) = "" Then
            txt_02_T21Nombre.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 21Nombre")
            Exit Function
        Else
            lbl_02_T21Nombre.ForeColor = Drawing.Color.Black
        End If
        If Trim(drop_02_T21Activo.Text) = "" Then
            drop_02_T21Activo.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 21Activo")
            Exit Function
        Else
            lbl_02_T21Activo.ForeColor = Drawing.Color.Black
        End If
    ...
    Private Function bValidarSQL() As Boolean
        ...
        If clsAdminDb.bVerificarSQL(txt_02_T21Codigo.Text) Then Exit Function
        If clsAdminDb.bVerificarSQL(txt_02_T21Nombre.Text) Then Exit Function
        bValidarSQL = True
        MostrarMensaje("")
    End Function
    ...
    Private Sub Cargar_Registro()
        ...
        If Not coleccionDatos Is Nothing Then
            If coleccionDatos.Length = 0 Then
                ...
                End If
            Else
                txt_02_T21Codigo.Text = coleccionDatos(0)
                txt_02_T21Nombre.Text = coleccionDatos(1)
                drop_02_T21Activo.Text = coleccionDatos(2)
    ...
    Private Sub cargar_Tabla(Optional ByVal sLlaveTem As String = "")
        ...
        Dim sCamposTablaLocal As String = _02_T21SEDE.CamposTabla
        Dim sLlavesLocal As String = _02_T21SEDE.CampoLlave_02_T21Codigo & "<>''"
        Dim sTablaLocal As String = _02_T21SEDE.NombreTabla
        Dim ArregloSingular() As String
