...
Public Class AtlOrigenmejora
    ...
    Private Sub Datos_Modulo()
        sCodModulo = _04_T13ATL_ORIGENMEJORA.CodigoModulo
        sNombreTabla = _04_T13ATL_ORIGENMEJORA.NombreTabla
        sCamposTabla = _04_T13ATL_ORIGENMEJORA.CamposTabla
        sCamposINS = "'" & clsAdminDb.sRemoverHTML(txt_04_T13Codigo.Text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_04_T13Nombre.Text) & "'" & "," & "'" & drop_04_T13Activo.Text & "'"
        sCamposUPD = _04_T13ATL_ORIGENMEJORA.Campo_04_T13Nombre & "='" & clsAdminDb.sRemoverHTML(txt_04_T13Nombre.Text) & "'" & "," & _04_T13ATL_ORIGENMEJORA.Campo_04_T13Activo & "='" & drop_04_T13Activo.Text & "'"
        sLlaves = _04_T13ATL_ORIGENMEJORA.CampoLlave_04_T13Codigo & "=  '" & txt_04_T13Codigo.Text & "'"
    End Sub
    ...
    Private Sub CargarDrops()
        ...
        With clsAdminDb
            ...
            drop_04_T13Activo.Items.Add(New ListItem("Seleccionar"))
            drop_04_T13Activo.Items.Add(New ListItem("Si"))
            drop_04_T13Activo.Items.Add(New ListItem("No"))
        End With
    End Sub
    ...
    Private Sub limpiarCampos()
        ...
        txt_04_T13Codigo.Text = Nothing
        txt_04_T13Nombre.Text = Nothing
        drop_04_T13Activo.Text = Nothing

        lbl_04_T13Codigo.ForeColor = Drawing.Color.Black
        lbl_04_T13Nombre.ForeColor = Drawing.Color.Black
        lbl_04_T13Activo.ForeColor = Drawing.Color.Black
    ...
    Private Function bValidarCampos() As Boolean
        ...
        lbl_04_T13Codigo.ForeColor = Drawing.Color.Red
        lbl_04_T13Nombre.ForeColor = Drawing.Color.Red
        lbl_04_T13Activo.ForeColor = Drawing.Color.Red
        If Trim(txt_04_T13Codigo.Text) = "" Then
            txt_04_T13Codigo.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 13Codigo")
            Exit Function
        Else
            lbl_04_T13Codigo.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_04_T13Nombre.Text) = "" Then
            txt_04_T13Nombre.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 13Nombre")
            Exit Function
        Else
            lbl_04_T13Nombre.ForeColor = Drawing.Color.Black
        End If
        If Trim(drop_04_T13Activo.Text) = "" Then
            drop_04_T13Activo.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 13Activo")
            Exit Function
        Else
            lbl_04_T13Activo.ForeColor = Drawing.Color.Black
        End If
    ...
    Private Function bValidarSQL() As Boolean
        ...
        If clsAdminDb.bVerificarSQL(txt_04_T13Codigo.Text) Then Exit Function
        If clsAdminDb.bVerificarSQL(txt_04_T13Nombre.Text) Then Exit Function
        bValidarSQL = True
        MostrarMensaje("")
    End Function
    ...
    Private Sub Cargar_Registro()
        ...
        If Not coleccionDatos Is Nothing Then
            If coleccionDatos.Length = 0 Then
                ...
                End If
            Else
                txt_04_T13Codigo.Text = coleccionDatos(0)
                txt_04_T13Nombre.Text = coleccionDatos(1)
                drop_04_T13Activo.Text = coleccionDatos(2)
    ...
    Private Sub cargar_Tabla(Optional ByVal sLlaveTem As String = "")
        Dim clsAdminDb As New adminitradorDB
        Dim coleccionDatosPlural As New Collection
        Dim sCamposTablaLocal As String = _04_T13ATL_ORIGENMEJORA.CamposTabla
        Dim sLlavesLocal As String = _04_T13ATL_ORIGENMEJORA.CampoLlave_04_T13Codigo & "<>''"
        Dim sTablaLocal As String = _04_T13ATL_ORIGENMEJORA.NombreTabla
        Dim ArregloSingular() As String
