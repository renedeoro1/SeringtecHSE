...
Public Class Personal
    ...
    Private Sub Datos_Modulo()
        sCodModulo = _02_T05PERSONAL.CodigoModulo
        sNombreTabla = _02_T05PERSONAL.NombreTabla
        sCamposTabla = _02_T05PERSONAL.CamposTabla
        sCamposINS = "'" & clsAdminDb.sRemoverHTML(txt_02_T05Id_Estadistica.Text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_02_T05Id_Personal.Text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_02_T05NombresApellidos.Text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_02_T05Identificacion.Text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_02_T05ICargo.Text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_02_T05IEmpresa.Text) & "'"
        sCamposUPD = _02_T05PERSONAL.Campo_02_T05NombresApellidos & "='" & clsAdminDb.sRemoverHTML(txt_02_T05NombresApellidos.Text) & "'" & "," & _02_T05PERSONAL.Campo_02_T05Identificacion & "='" & clsAdminDb.sRemoverHTML(txt_02_T05Identificacion.Text) & "'" & "," & _02_T05PERSONAL.Campo_02_T05ICargo & "='" & clsAdminDb.sRemoverHTML(txt_02_T05ICargo.Text) & "'" & "," & _02_T05PERSONAL.Campo_02_T05IEmpresa & "='" & clsAdminDb.sRemoverHTML(txt_02_T05IEmpresa.Text) & "'"
        sLlaves = _02_T05PERSONAL.CampoLlave_02_T05Id_Estadistica & "=  '" & txt_02_T05Id_Estadistica.Text & "'" & " AND " & _02_T05PERSONAL.CampoLlave_02_T05Id_Personal & "=  '" & txt_02_T05Id_Personal.Text & "'"
    End Sub
    ...
    Private Sub bHabilitarControles(ByVal bEstado As Boolean)
        txt_02_T05Id_Estadistica.Enabled = bEstado
        txt_02_T05Id_Personal.Enabled = bEstado
        txt_02_T05NombresApellidos.Enabled = bEstado
        txt_02_T05Identificacion.Enabled = bEstado
        txt_02_T05ICargo.Enabled = bEstado
        txt_02_T05IEmpresa.Enabled = bEstado
    ...
    Private Function bValidarCampos() As Boolean
        ...
        If Trim(txt_02_T05Id_Estadistica.Text) = "" Then
            txt_02_T05Id_Estadistica.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 05Id_Estadistica")
            Exit Function
        Else
            lbl_02_T05Id_Estadistica.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_02_T05Id_Personal.Text) = "" Then
            ...
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 05Id_Personal")
            Exit Function
        Else
            lbl_02_T05Id_Personal.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_02_T05NombresApellidos.Text) = "" Then
            ...
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 05NombresApellidos")
            Exit Function
        Else
            lbl_02_T05NombresApellidos.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_02_T05Identificacion.Text) = "" Then
            ...
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 05Identificacion")
            Exit Function
        Else
            lbl_02_T05Identificacion.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_02_T05ICargo.Text) = "" Then
            ...
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 05ICargo")
            Exit Function
        Else
            lbl_02_T05ICargo.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_02_T05IEmpresa.Text) = "" Then
            ...
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 05IEmpresa")
            Exit Function
        Else
            lbl_02_T05IEmpresa.ForeColor = Drawing.Color.Black
        End If
