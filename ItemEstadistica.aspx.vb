...
Public Class ItemEstadistica
    ...
    Private Sub Datos_Modulo()
        sCodModulo = _02_T17ITEMESTADISTICADIARIA.CodigoModulo
        sNombreTabla = _02_T17ITEMESTADISTICADIARIA.NombreTabla
        sCamposTabla = _02_T17ITEMESTADISTICADIARIA.CamposTabla
        sCamposINS = "'" & clsAdminDb.sRemoverHTML(txt_02_T17Codigo.text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_02_T17Nombre.text) & "'" & "," & "'" & drop_02_T17Activo.text & "'"
        sCamposUPD = _02_T17ITEMESTADISTICADIARIA.Campo_02_T17Nombre & "='" & clsAdminDb.sRemoverHTML(txt_02_T17Nombre.text) & "'"
        sLlaves = _02_T17ITEMESTADISTICADIARIA.CampoLlave_02_T17Codigo & "=  '" & txt_02_T17Codigo.text & "'" & " AND " & _02_T17ITEMESTADISTICADIARIA.CampoLlave_02_T17Activo & "=  '" & drop_02_T17Activo.text & "'"
    End Sub
    ...
    Private Sub CargarDrops()
        ...
        With clsAdminDb
            ...
            drop_02_T17Activo.Items.Add(New ListItem("Seleccionar"))
            drop_02_T17Activo.Items.Add(New ListItem("Si"))
            drop_02_T17Activo.Items.Add(New ListItem("No"))
    ...
    Private Sub limpiarCampos()
        ...
        txt_02_T17Codigo.text = Nothing
        txt_02_T17Nombre.text = Nothing
        drop_02_T17Activo.text = Nothing

        lbl_02_T17Codigo.ForeColor = Drawing.Color.Black
        lbl_02_T17Nombre.ForeColor = Drawing.Color.Black
        lbl_02_T17Activo.ForeColor = Drawing.Color.Black
    ...
    Private Sub bHabilitarControles(ByVal bEstado As Boolean)
        txt_02_T17Codigo.Enabled = bEstado
        txt_02_T17Nombre.Enabled = bEstado
        drop_02_T17Activo.Enabled = bEstado
    ...
    Private Function bValidarCampos() As Boolean
        ...
        lbl_02_T17Codigo.ForeColor = Drawing.Color.Red
        lbl_02_T17Nombre.ForeColor = Drawing.Color.Red
        lbl_02_T17Activo.ForeColor = Drawing.Color.Red
        If Trim(txt_02_T17Codigo.text) = "" Then
            txt_02_T17Codigo.focus
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 17Codigo")
            Exit Function
        Else
            lbl_02_T17Codigo.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_02_T17Nombre.text) = "" Then
            txt_02_T17Nombre.focus
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 17Nombre")
            Exit Function
        Else
            lbl_02_T17Nombre.ForeColor = Drawing.Color.Black
        End If
        If Trim(drop_02_T17Activo.text) = "" Then
            drop_02_T17Activo.focus
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 17Activo")
            Exit Function
        Else
            lbl_02_T17Activo.ForeColor = Drawing.Color.Black
        End If
    ...
    Private Function bValidarSQL() As Boolean
        ...
        If clsAdminDb.bVerificarSQL(txt_02_T17Codigo.text) Then Exit Function
        If clsAdminDb.bVerificarSQL(txt_02_T17Nombre.text) Then Exit Function
        bValidarSQL = True
        MostrarMensaje("")
    End Function
    ...
    Private Sub Cargar_Registro()
        ...
        If Not coleccionDatos Is Nothing Then
            If coleccionDatos.Length = 0 Then
                ...
                End If
            Else
                txt_02_T17Codigo.text = coleccionDatos(0)
                txt_02_T17Nombre.text = coleccionDatos(1)
                drop_02_T17Activo.text = coleccionDatos(2)
    ...
    Private Sub cargar_Tabla(Optional ByVal sLlaveTem As String = "")
        ...
        Dim sCamposTablaLocal As String = _02_T17ITEMESTADISTICADIARIA.CamposTabla
        Dim sLlavesLocal As String = _02_T17ITEMESTADISTICADIARIA.CampoLlave_02_T17Codigo & "<>''"
        Dim sTablaLocal As String = _02_T17ITEMESTADISTICADIARIA.NombreTabla
        Dim ArregloSingular() As String
