...
Public Class tipoaccion
    ...
    Private Sub Datos_Modulo()
        sCodModulo = _02_T02TIPO_ACCION.CodigoModulo
        sNombreTabla = _02_T02TIPO_ACCION.NombreTabla
        sCamposTabla = _02_T02TIPO_ACCION.CamposTabla
        sCamposINS = "'" & clsAdminDb.sRemoverHTML(txt_02_T02Id.Text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_02_T02Nombre.Text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(drop_02_T02Activo.Text) & "'"
        sCamposUPD = _02_T02TIPO_ACCION.Campo_02_T02Nombre & "='" & clsAdminDb.sRemoverHTML(txt_02_T02Nombre.Text) & "'" & "," & _02_T02TIPO_ACCION.Campo_02_T02Activo & "='" & clsAdminDb.sRemoverHTML(drop_02_T02Activo.Text) & "'"
        sLlaves = _02_T02TIPO_ACCION.CampoLlave_02_T02Id & "=  '" & txt_02_T02Id.Text & "'"
    End Sub
    ...
    Private Sub CargarDrops()
        ...
        With clsAdminDb
            ...
            .drop_Cargar_SINO(drop_02_T02Activo, False)
            ...
            '.drop_CargarCombox(drop_01_T20Categoria, _01_T06DISCIPLINAS.NombreTabla, _01_T06DISCIPLINAS.CampoLlave_01_T06Codigo & "," & _01_T06DISCIPLINAS.Campo_01_T06Nombre, _01_T06DISCIPLINAS.Campo_01_T06Activo & "='SI'", True)
            '.drop_CargarCombox(drop_01_T04NumDocLider, _01_T12FUNCIONARIOS.NombreTabla, _01_T12FUNCIONARIOS.CampoLlave_01_T12NumDoc & "," & _01_T12FUNCIONARIOS.Campo_01_T12NombreApellidos, _01_T12FUNCIONARIOS.Campo_01_T12Activo & "='SI'", True)
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        lblMensajeGuardarPopup.Text = "Para guardar este registro pulse Guardar"
    End Sub
    ...
    Private Sub limpiarCampos()
        txt_02_T02Id.Text = Nothing
        txt_02_T02Nombre.Text = Nothing
        drop_02_T02Activo.Text = Nothing

        lbl_02_T02Id.ForeColor = Drawing.Color.Black
        lbl_02_T02Nombre.ForeColor = Drawing.Color.Black
        lbl_02_T02Activo.ForeColor = Drawing.Color.Black
    ...
    Private Function bValidarCampos() As Boolean
        ...
        lbl_02_T02Id.ForeColor = Drawing.Color.Red
        lbl_02_T02Nombre.ForeColor = Drawing.Color.Red
        lbl_02_T02Activo.ForeColor = Drawing.Color.Red
        If Trim(txt_02_T02Id.Text) = "" Then
            txt_02_T02Id.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 02Id")
            Exit Function
        Else
            lbl_02_T02Id.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_02_T02Nombre.Text) = "" Then
            txt_02_T02Nombre.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 02Nombre")
            Exit Function
        Else
            lbl_02_T02Nombre.ForeColor = Drawing.Color.Black
        End If
        If Trim(drop_02_T02Activo.Text) = "" Then
            drop_02_T02Activo.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 02Activo")
            Exit Function
        Else
            lbl_02_T02Activo.ForeColor = Drawing.Color.Black
        End If
    ...
    Private Function bValidarSQL() As Boolean
        ...
        If clsAdminDb.bVerificarSQL(txt_02_T02Id.Text) Then Exit Function
        If clsAdminDb.bVerificarSQL(txt_02_T02Nombre.Text) Then Exit Function
        If clsAdminDb.bVerificarSQL(drop_02_T02Activo.Text) Then Exit Function
        bValidarSQL = True
        MostrarMensaje("")
    End Function
    ...
    Private Sub Cargar_Registro()
        ...
        If Not coleccionDatos Is Nothing Then
            If coleccionDatos.Length = 0 Then
                ...
                End If
            Else
                txt_02_T02Id.Text = coleccionDatos(0)
                txt_02_T02Nombre.Text = coleccionDatos(1)
                drop_02_T02Activo.Text = coleccionDatos(2)
    ...
    Private Sub cargar_Tabla(Optional ByVal sLlaveTem As String = "")
        'Dim clsAdminDb As New adminitradorDB
        Dim coleccionDatosPlural As New Collection
        Dim sCamposTablaLocal As String = _02_T02TIPO_ACCION.CamposTabla
        Dim sLlavesLocal As String = _02_T02TIPO_ACCION.CampoLlave_02_T02Id & "<>''"
        Dim sTablaLocal As String = _02_T02TIPO_ACCION.NombreTabla
        Dim ArregloSingular() As String
        ...
        If (Not coleccionDatosPlural Is Nothing) Then
            For Each ColeccionSingular In coleccionDatosPlural
                ...
                linkbutonHtml_Eliminar.ID = i & "f-sep-" & ArregloSingular(0).ToString '& "-sep-" & ArregloSingular(1).ToString '& "sep" & ArregloSingular(2).ToString & "sep" & ArregloSingular(4).ToString
