...
Public Class HUB
    ...
    Private Sub Datos_Modulo()
        sCodModulo = _02_T16HUB.CodigoModulo
        sNombreTabla = _02_T16HUB.NombreTabla
        sCamposTabla = _02_T16HUB.CamposTabla
        sCamposINS = "'" & clsAdminDb.sRemoverHTML(txt_02_T16Codigo.text) & "'" & "," & "'" & clsAdminDb.sRemoverHTML(txt_02_T16Nombre.text) & "'" & "," & "'" & drop_02_T16Activo.text & "'"
        sCamposUPD = _02_T16HUB.Campo_02_T16Nombre & "='" & clsAdminDb.sRemoverHTML(txt_02_T16Nombre.text) & "'" & "," & _02_T16HUB.Campo_02_T16Activo & "='" & drop_02_T16Activo.text & "'"
        sLlaves = _02_T16HUB.CampoLlave_02_T16Codigo & "=  '" & txt_02_T16Codigo.text & "'"
    End Sub
    ...
    Private Sub CargarDrops()
        ...
        With clsAdminDb
            ...
            drop_02_T16Activo.Items.Add(New ListItem("Seleccionar"))
            drop_02_T16Activo.Items.Add(New ListItem("Si"))
            drop_02_T16Activo.Items.Add(New ListItem("No"))
    ...
    Private Sub limpiarCampos()
        ...
        txt_02_T16Codigo.text = Nothing
        txt_02_T16Nombre.text = Nothing
        drop_02_T16Activo.text = Nothing

        lbl_02_T16Codigo.ForeColor = Drawing.Color.Black
        lbl_02_T16Nombre.ForeColor = Drawing.Color.Black
        lbl_02_T16Activo.ForeColor = Drawing.Color.Black
    ...
    Private Function bValidarCampos() As Boolean
        ...
        lbl_02_T16Codigo.ForeColor = Drawing.Color.Red
        lbl_02_T16Nombre.ForeColor = Drawing.Color.Red
        lbl_02_T16Activo.ForeColor = Drawing.Color.Red
        If Trim(txt_02_T16Codigo.Text) = "" Then
            txt_02_T16Codigo.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 16Codigo")
            Exit Function
        Else
            lbl_02_T16Codigo.ForeColor = Drawing.Color.Black
        End If
        If Trim(txt_02_T16Nombre.Text) = "" Then
            txt_02_T16Nombre.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 16Nombre")
            Exit Function
        Else
            lbl_02_T16Nombre.ForeColor = Drawing.Color.Black
        End If
        If Trim(drop_02_T16Activo.Text) = "" Then
            drop_02_T16Activo.Focus()
            MostrarMensaje("Por favor ingrese datos en los campos obligatorios marcados en rojo - falta campo: 16Activo")
            Exit Function
        Else
            lbl_02_T16Activo.ForeColor = Drawing.Color.Black
        End If
    ...
    Private Function bValidarSQL() As Boolean
        ...
        If clsAdminDb.bVerificarSQL(txt_02_T16Codigo.Text) Then Exit Function
        If clsAdminDb.bVerificarSQL(txt_02_T16Nombre.Text) Then Exit Function
        bValidarSQL = True
        MostrarMensaje("")
    End Function
    ...
    Private Sub Cargar_Registro()
        ...
        If Not coleccionDatos Is Nothing Then
            If coleccionDatos.Length = 0 Then
                ...
                End If
            Else
                txt_02_T16Codigo.Text = coleccionDatos(0)
                txt_02_T16Nombre.Text = coleccionDatos(1)
                drop_02_T16Activo.Text = coleccionDatos(2)
    ...
    Private Sub cargar_Tabla(Optional ByVal sLlaveTem As String = "")
        Dim clsAdminDb As New adminitradorDB
        Dim coleccionDatosPlural As New Collection
        Dim sCamposTablaLocal As String = _02_T16HUB.CamposTabla
        Dim sLlavesLocal As String = _02_T16HUB.CampoLlave_02_T16Codigo & "<>''"
        Dim sTablaLocal As String = _02_T16HUB.NombreTabla
