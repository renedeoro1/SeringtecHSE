<%@ Page Debug="true" ValidateRequest="false" Language="vb" AutoEventWireup="false" CodeBehind="AtlOrigenmejora.aspx.vb" Inherits="HSENUEVO.AtlOrigenmejora" %>
                                            ...
                                            <div class="pure-g-r">
                                                <div class="pure-u-1">
                                                    <table>
                                                        <tr>
                                                            <td style="width: 80px">
                                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/iconos/MejoraOrigen.png" />
                                                            </td>
                                                            <td>
                                                                <h1>Atl Origen Mejora</h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                        ...
                                                        <div id="divContendio" runat="server" class="pure-form pure-form-stacked">
                                                            <div class="pure-g-r">
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_04_T13Codigo" runat="server" Text="Codigo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_04_T13Codigo" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_04_T13Codigo" runat="server" Enabled="True" TargetControlID="txt_04_T13Codigo" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_04_T13Nombre" runat="server" Text="Nombre" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_04_T13Nombre" runat="server" Width="90%" MaxLength="200"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_04_T13Nombre" runat="server" Enabled="True" TargetControlID="txt_04_T13Nombre" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_04_T13Activo" runat="server" Text="Activo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:DropDownList ID="drop_04_T13Activo" runat="server" class="chzn-select" Width="90%" placeholder="1_T13Activo"></asp:DropDownList>
                                                                </div>
                                                            </div>
