...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			//Length.innerHTML = '<label>'+oSettings.oLanguage.sLengthMenu.replace( '_MENU_', sStdMenu )+'</label>';
		...
		return this.each(function() {
			...
			for ( i=0, iLen=DataTable.settings.length ; i<iLen ; i++ )
			{
				...
				if ( DataTable.settings[i].nTable == this )
				{
					...
					{
					    _fnLog(DataTable.settings[i], 0, "Error al generar la tabla de registros guardados.\n\n" +
							"Por favor recargue nuevamente la pagina y espere hasta que termine de cargar completamente para " +
							"activar todos los servicios y funcionalidades de sistema");
					    return;
	...
	DataTable.defaults = {
		...
		//"aaSorting": [[0, 'desc']],
		"aaSorting": [],
        //miguel: para cambiar el orden de la filas de las tablas
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "No hay datos cargado en la tabla",
			 ...
			 *    } );
			 */
			"sInfo": "Registro del _START_ al _END_ de un Total _TOTAL_ Registros",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Registros del 0 al 0 de 0 Encontrados",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Filtro de _MAX_ total encontrados)",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Registros _MENU_ Encontrados",
