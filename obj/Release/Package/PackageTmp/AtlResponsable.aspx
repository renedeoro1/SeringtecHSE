<%@ Page Debug="true" ValidateRequest="false" Language="vb" AutoEventWireup="false" CodeBehind="AtlResponsable.aspx.vb" Inherits="HSENUEVO.AtlResponsable" %>
                                                        ...
                                                        <div id="divContendio" runat="server" class="pure-form pure-form-stacked">
                                                            <div class="pure-g-r">
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_04_T14Codigo" runat="server" Text="Codigo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_04_T14Codigo" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_04_T14Codigo" runat="server" Enabled="True" TargetControlID="txt_04_T14Codigo" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_04_T14Nombre" runat="server" Text="Nombre" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_04_T14Nombre" runat="server" Width="90%" MaxLength="200"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_04_T14Nombre" runat="server" Enabled="True" TargetControlID="txt_04_T14Nombre" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_04_T14Activo" runat="server" Text="Activo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:DropDownList ID="drop_04_T14Activo" runat="server" class="chzn-select" Width="90%" placeholder="1_T14Activo"></asp:DropDownList>
                                                                </div>
