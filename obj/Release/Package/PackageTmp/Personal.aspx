<%@ Page Debug="true" ValidateRequest="false" Language="vb" AutoEventWireup="false" CodeBehind="Personal.aspx.vb" Inherits="HSENUEVO.Personal" %>
                                            ...
                                            <div class="pure-g-r">
                                                <div class="pure-u-1">
                                                    <table>
                                                        <tr>
                                                            <td style="width: 80px">
                                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/iconos/Personal.png" />
                                                            </td>
                                                            <td>
                                                                <h1>Personal</h1>
                                                            </td>
                                                        ...
                                                        <div id="divContendio" runat="server" class="pure-form pure-form-stacked">
                                                            <div class="pure-g-r">
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T05Id_Estadistica" runat="server" Text="Id Estadistica" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T05Id_Estadistica" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T05Id_Estadistica" runat="server" Enabled="True" TargetControlID="txt_02_T05Id_Estadistica" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T05Id_Personal" runat="server" Text="Id Personal" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T05Id_Personal" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                ...
                                                                <div class="pure-u-1-6">
                                                                    ...
                                                                    <asp:TextBox ID="txt_02_T05Identificacion" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                ...
                                                                <div class="pure-u-1-6">
                                                                    ...
                                                                    <asp:TextBox ID="txt_02_T05ICargo" runat="server" Width="90%" MaxLength="200"></asp:TextBox>
                                                                ...
                                                                <div class="pure-u-1-6">
                                                                    ...
                                                                    <asp:TextBox ID="txt_02_T05IEmpresa" runat="server" Width="90%" MaxLength="200"></asp:TextBox>
