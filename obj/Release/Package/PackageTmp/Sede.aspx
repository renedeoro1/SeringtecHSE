<%@ Page Debug="true" ValidateRequest="false" Language="vb" AutoEventWireup="false" CodeBehind="Sede.aspx.vb" Inherits="HSENUEVO.Sede" %>
                                            ...
                                            <div class="pure-g-r">
                                                <div class="pure-u-1">
                                                    <table>
                                                        <tr>
                                                            <td style="width: 80px">
                                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/iconos/Sede.png" />
                                                            </td>
                                                            <td>
                                                                <h1>Sede</h1>
                                                            </td>
                                                        ...
                                                        <div id="divContendio" runat="server" class="pure-form pure-form-stacked">
                                                            <div class="pure-g-r">
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T21Codigo" runat="server" Text="1Codigo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T21Codigo" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T21Codigo" runat="server" Enabled="True" TargetControlID="txt_02_T21Codigo" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T21Nombre" runat="server" Text="1Nombre" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T21Nombre" runat="server" Width="90%" MaxLength="300"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T21Nombre" runat="server" Enabled="True" TargetControlID="txt_02_T21Nombre" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T21Activo" runat="server" Text="1Activo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:DropDownList ID="drop_02_T21Activo" runat="server" class="chzn-select" Width="90%" placeholder="1_T21Activo"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </fieldset>
