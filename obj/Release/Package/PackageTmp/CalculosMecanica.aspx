                                            ...
                                            <div class="pure-g-r">
                                                <div class="pure-u-1">
                                                    <table>
                                                        <tr>
                                                            <td style="width: 80px">
                                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/iconos/calculo.png" Height="118px" Width="135px" />
                                                            </td>
                                                            <td>
                                                                <h1>Cálculo</h1>
                                                            </td>
                                        ...
                                        <div class="widget-box">
                                            <div class="form-horizontal well" style="border: medium double #000000; width: 1030px; height: 2029px; color: #000000;">
                                                ...
                                                CALCULO DE PRESION DE PRUEBA DE MTU-ES-08_V1 ( TAMBIEN APLICA MTU-ES-08_V1):<table class="auto-style14" style="border-style: solid; color: #808080; text-decoration: none;">
                                                    ...
                                                    PRYOECCIÓN DE BOQUILLAS:</strong><table class="auto-style14" style="border-style: solid; color: #808080; text-decoration: none;">
                                                    <tr>
                                                        <strong>

                                                        <td class="auto-style9" style="border-style: solid; text-decoration: none; color: #000000;">
                                                            <asp:Label ID="lbl_01_T02Proyeccionboquilla2" runat="server" Font-Bold="True" Font-Size="10pt" Text="Proyección boquilla 2r" Visible="true"></asp:Label>
                                                        </td>
                                                        <td class="auto-style17" style="border-style: solid; "><strong></strong></td>
                                                        <td class="auto-style25" style="border-style: solid; text-decoration: none; color: #000000;"><strong>
                                                            <asp:TextBox ID="txt_01_T02Proyeccionboquilla2" runat="server"></asp:TextBox>
                                                            <asp:FilteredTextBoxExtender ID="filtered_01_T02Proyeccionboquilla2" runat="server" Enabled="True" TargetControlID="txt_01_T02Esfuerzocircunferencialbarrilmenor" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                        </strong></td>
                                                        <td class="auto-style17" style="border-style: solid; "><strong>In</strong></td>
                                                        <td class="jqplot-error" style="border-style: solid; text-decoration: none; color: #000000;">&nbsp;</td>
                                                        </strong>
                                                    </tr>
                                                    <tr>
                                                        <strong>
                                                        <td class="auto-style9" style="border-style: solid; text-decoration: none; color: #000000;">
                                                            <asp:Label ID="lbl_01_T02Proyeccionboquilla4" runat="server" Font-Bold="True" Font-Size="10pt" Text="Proyección boquilla 4" Visible="true"></asp:Label>
                                                        </td>
                                                            <td class="auto-style35" style="border-style: solid; "><strong></strong></td>
                                                        <td class="auto-style36" style="border-style: solid; text-decoration: none; color: #000000;"><strong>
                                                            <asp:TextBox ID="txt_01_T02Proyeccionboquilla4" runat="server"></asp:TextBox>
                                                            <asp:FilteredTextBoxExtender ID="filtered_01_T02Proyeccionboquilla4" runat="server" Enabled="True" TargetControlID="txt_01_T02Esfuerzocircunferencialbarrilmenor" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                        </strong></td>
                                                        <td class="auto-style37" style="border-style: solid; text-decoration: none; color: #000000;"><strong>In</strong></td>
                                                        <td class="auto-style37" style="border-style: solid; text-decoration: none; color: #000000;">&nbsp;</td>
                                                        </strong>
                                                    </tr>
                                                </table>
                                            </div>
