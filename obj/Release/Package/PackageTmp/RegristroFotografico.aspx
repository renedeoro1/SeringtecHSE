<%@ Page Debug="true" ValidateRequest="false" Language="vb" AutoEventWireup="false" CodeBehind="RegristroFotografico.aspx.vb" Inherits="HSENUEVO.RegistroFotografico" %>
                                            ...
                                            <div class="pure-g-r">
                                                <div class="pure-u-1">
                                                    <table>
                                                        <tr>
                                                            <td style="width: 80px">
                                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/iconos/Registro_foto.png" />
                                                            </td>
                                                            <td>
                                                        ...
                                                        <div id="divContendio" runat="server" class="pure-form pure-form-stacked">
                                                            <div class="pure-g-r">
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T07Id_Estadistica" runat="server" Text="Id Estadistica" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T07Id_Estadistica" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T07Id_Estadistica" runat="server" Enabled="True" TargetControlID="txt_02_T07Id_Estadistica" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T07Id_registroFotografico" runat="server" Text="Id Registro Fotografico" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T07Id_registroFotografico" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                ...
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T07Id_BD" runat="server" Text="Id BD" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T07Id_BD" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                ...
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T07Id_BD_Item" runat="server" Text="Id BD Item" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T07Id_BD_Item" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                ...
                                                                <div class="pure-u-1-6">
                                                                    ...
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T07Fecha" runat="server" Enabled="True" TargetControlID="txt_02_T07Fecha" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
