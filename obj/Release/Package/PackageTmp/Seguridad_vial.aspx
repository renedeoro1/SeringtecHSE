<%@ Page Debug="true" ValidateRequest="false" Language="vb" AutoEventWireup="false" CodeBehind="Seguridad_vial.aspx.vb" Inherits="HSENUEVO.Seguridad_vial" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div class="row-fluid">
                                            ...
                                            <div class="pure-g-r">
                                                <div class="pure-u-1">
                                                    <table>
                                                        <tr>
                                                            <td style="width: 80px">
                                                                <asp:Image ID="Image1" runat="server" ImageUrl="~/iconos/Seguridad_Vial.png" />
                                                            </td>
                                                            <td>
                                                    ...
                                                    <fieldset>
                                                        <div id="divContendio" runat="server" class="pure-form pure-form-stacked">
                                                            <div class="pure-g-r">
                                                                    ...
                                                                    <asp:Label ID="lbl_02_T06Id_Estadistica" runat="server" Text="Id Estadistica" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T06Id_Estadistica" runat="server" Width="99%" MaxLength="30"></asp:TextBox>
                                                                    ...
                                                                    <asp:Label ID="lbl_02_T06Id_SeguridadVial" runat="server" Text="Id SeguridadVial" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T06Id_SeguridadVial" runat="server" Width="99%" MaxLength="30"></asp:TextBox>
                                                                    ...
                                                                    <asp:Label ID="lbl_02_T06TipoVehiculo" runat="server" Text="Tipo Vehiculo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T06TipoVehiculo" runat="server" Width="90%" MaxLength="50"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T06TipoVehiculo" runat="server" Enabled="True" TargetControlID="txt_02_T06KmInicial" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>

                                                                    <asp:Label ID="lbl_02_T06PlacaVehiculo" runat="server" Text="Placa Vehiculo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T06PlacaVehiculo" runat="server" Width="90%" MaxLength="50"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T06PlacaVehiculo" runat="server" Enabled="True" TargetControlID="txt_02_T06PlacaVehiculo" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                    ...
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T06KmInicial" runat="server" Enabled="True" TargetControlID="txt_02_T06KmInicial" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                    ...
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T06KmFinal" runat="server" Enabled="True" TargetControlID="txt_02_T06KmFinal" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>

                                                                    <asp:Label ID="lbl_02_T06TotalKm" runat="server" Text="Total Km" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T06TotalKm" runat="server" Width="90%" MaxLength="50"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T06TotalKm" runat="server" Enabled="True" TargetControlID="txt_02_T06TotalKm" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>

                                                                    <asp:Label ID="lbl_02_T06EmpresaAffiliacionVehiculo" runat="server" Text="Empresa Affiliacion Vehiculo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                            ...
                            <div class="widget-head" style="height: 20  x">
                            ...
                            <table class="data-tbl-simple table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>6Empresa Affiliacion Vehiculo
                                        </th>
                                        <th>FUEC
                                        </th>
                                        <th>Nombre Conductor
                                        </th>
                                        <th>Documento Conductor
                                        </th>
                                    </tr>
