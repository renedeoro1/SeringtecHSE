<%@ Page Debug="true" ValidateRequest="false" Language="vb" AutoEventWireup="false" CodeBehind="HUB.aspx.vb" Inherits="HSENUEVO.HUB" %>
                                                        ...
                                                        <div id="divContendio" runat="server" class="pure-form pure-form-stacked">
                                                            <div class="pure-g-r">
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T16Codigo" runat="server" Text="6Codigo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T16Codigo" runat="server" Width="90%" MaxLength="30"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T16Codigo" runat="server" Enabled="True" TargetControlID="txt_02_T16Codigo" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T16Nombre" runat="server" Text="6Nombre" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:TextBox ID="txt_02_T16Nombre" runat="server" Width="90%" MaxLength="500"></asp:TextBox>
                                                                    <asp:FilteredTextBoxExtender ID="filtered_02_T16Nombre" runat="server" Enabled="True" TargetControlID="txt_02_T16Nombre" FilterType="Numbers,LowercaseLetters,UppercaseLetters,Custom" FilterMode="InvalidChars" ValidChars="'"></asp:FilteredTextBoxExtender>
                                                                </div>
                                                                <div class="pure-u-1-6">
                                                                    <asp:Label ID="lbl_02_T16Activo" runat="server" Text="6Activo" Font-Bold="True" Font-Size="10pt"></asp:Label>
                                                                    <asp:DropDownList ID="drop_02_T16Activo" runat="server" class="chzn-select" Width="90%" placeholder="1_T16Activo"></asp:DropDownList>
                                                                </div>
                                                            </div>
